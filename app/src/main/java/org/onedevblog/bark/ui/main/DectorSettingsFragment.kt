...
class DetectorSettingsFragment : Fragment(), CanBeSaved {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<EditText>(R.id.start_delay_edit).setText(detectorPref.startDelay.toString())
    ...
    override fun save() {
        ...
        detectorPref.startDelay = activity!!.findViewById<EditText>(R.id.start_delay_edit).text.toString().toInt()
